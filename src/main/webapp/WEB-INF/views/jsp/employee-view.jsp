		...
		<div id="page-content-wrapper">
			<div class="container-fluid">
				...
				<div style="text-align: center" id="menuproduct" class="col-sm-12">
					<i class="fa fa-file-text" aria-hidden="true"></i> XEM THÔNG
					TIN KHÁCH HÀNG
				</div>
				<br />

				<c:url value="/KhachHangview" var="customer-view" />
				<form:form id="KhachHangview" action="${customer-view}"
					modelAttribute="khachhang" enctype="multipart/form-data">
					<label id="textfield" class="col-sm-12">Tên Khách Hàng:</label>
					<form:input path="ten" class="form-control form-control-lg" />
					<br />
					...
					<output id="list">
						<c:choose>
							<c:when test="${not empty khachhang.image }">
								<img src="/AgileProject3/resources/image/${khachhang.image }"
									width="120">
								<form:input path="image" style="visibility: hidden"
									value="${khachhang.image }" />
							</c:when>
							<c:otherwise>
